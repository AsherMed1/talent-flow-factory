...
export const ApplicationFormHeader = ({ onClearSavedData, roleName, roleDescription }: ApplicationFormHeaderProps) => {
  // Use dynamic role name or fallback to default
            ...
            <div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Remote work with <strong>flexible schedule</strong></span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Check className="w-5 h-5 text-green-600 flex-shrink-0" />
                  ...
                  <div className="flex items-center gap-2">
                    <Check className="w-5 h-5 text-green-600 flex-shrink-0" />
                    <span>Collaborative <strong>creative environment</strong></span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Diamond className="w-5 h-5 text-blue-600 flex-shrink-0" />
                    <span><strong>Strong portfolio</strong> showcasing video work</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Diamond className="w-5 h-5 text-blue-600 flex-shrink-0" />
                    <span><strong>Creative problem-solving skills</strong></span>
                  </div>
                </div>
              </div>
            </div>
